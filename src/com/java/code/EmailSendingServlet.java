...
public class EmailSendingServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// String content="<a
		// href='http://localhost:8080/EmailFacility/ForgotPassword.jsp'> Click on Link
		// </a>";
		String content = "Hello! I am Min Phyoe Min Thu.";
		 ...
		 * +
		 * "<a href='http://localhost:8080/EmailFacility/Result.jsp'>Click on Link</a>";
